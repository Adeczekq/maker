  ...
  return (
    <div className="flex flex-col gap-24 items-center xl:flex-row xl:justify-center">
      <div className=" flex flex-col bg-secondary p-9 rounded-xl gap-4 max-w-96">
        <img className="w-12 -mt-14 " src="src/assets/icon-free.svg" />
        ...
        <div className="flex flex-col gap-4">
          <div className="flex gap-5 items-center">
            <img className="w-3 h-2 " src="src/assets/icon-check.svg" />
      ...
      <div className=" flex flex-col bg-primary p-9 rounded-xl gap-4  max-w-96">
        <img className="w-12 -mt-16 " src="src/assets/icon-paid.svg" />
        ...
        <div className="flex flex-col gap-4">
          <div className="flex gap-5 items-center">
            <img className="w-3 h-2 " src="src/assets/icon-check-second.svg" />
